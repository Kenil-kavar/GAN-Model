...
data_path = "Untitled Folder"
batch_s = 16
#Import as tf.Dataset
data = tf.keras.preprocessing.image_dataset_from_directory(data_path, label_mode = None, image_size = (256,256), batch_size = batch_s)
...
generator.add(Dense(16*16*256,activation="relu",input_dim=latent_dim))
...
discriminator.add(Conv2D(32, kernel_size=3, strides=2, input_shape=(256,256,3), padding="same"))
...
Discriminator_Verdict = discriminator(Generated_Portrait)  #for the random image generated
